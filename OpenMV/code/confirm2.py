...
black_threshold  = (   3,   39,  -29,   2,   1,   25)
...
#m1:ROI+statistic
    ...
    #if 0<statistics.l_mode()<0 and 0<statistics.a_mode()<0 and 0<statistics.b_mode()<0 :#if the circle is blue
    #    if PinState == 1:
    #        SendData2(1)        #发出1表示异常情况
...
#######pid区域 返回坐标值
    ...
    if blobs_black:
        ...
        img.draw_rectangle(max_blob_black.rect(),color=(205,133,63))
        img.draw_cross(max_blob_black.cx(), max_blob_black.cy(),color=(255,255,255))
        SendData3(2,max_blob_red.cx,max_blob_red.cy)
    else:
