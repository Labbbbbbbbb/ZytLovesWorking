...
x_dot_P = diff(x_P,t);
y_dot_P = diff(y_P,t);
x_dot_P = subs(x_dot_P,diff(phi2,t),phi_dot_2);
x_dot_P = subs(x_dot_P,[diff(phi1,t),diff(phi4,t)],[phi_dot_1,phi_dot_4]);
y_dot_P = subs(y_dot_P,diff(phi2,t),phi_dot_2);
y_dot_P = subs(y_dot_P,[diff(phi1,t),diff(phi4,t)],[phi_dot_1,phi_dot_4]);

xp_dot = [x_dot_P; y_dot_P];
xp_dot = collect(simplify(collect(xp_dot,q_dot)),q_dot);
Jp = simplify(jacobian(xp_dot,q_dot));